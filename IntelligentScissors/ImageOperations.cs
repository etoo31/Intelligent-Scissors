...
namespace IntelligentScissors
{
    ...
    public class ImageOperations
    {
        ...
        public static double CalculateRightPixelEnergy(int x, int y, RGBPixel[,] ImageMatrix)
        {
            return CalculatePixelEnergies(x, y, ImageMatrix).X;
        }
        public static double CalculateLeftPixelEnergy(int x, int y, RGBPixel[,] ImageMatrix)
        {
            return CalculatePixelEnergies(x-1, y, ImageMatrix).X;
        }

        public static double CalculateBottomPixelEnergy(int x, int y, RGBPixel[,] ImageMatrix)
        {
            return CalculatePixelEnergies(x, y, ImageMatrix).Y;
        }

        public static double CalculateTopPixelEnergy(int x, int y, RGBPixel[,] ImageMatrix)
        {
            return CalculatePixelEnergies(x, y-1, ImageMatrix).Y;
        }
